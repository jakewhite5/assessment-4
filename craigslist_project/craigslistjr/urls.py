...
urlpatterns = [
    ...
    path("categories/<int:category_id>/posts/new", views.post_new, name='category_new'), #A page with a form to create a new post, under the current category by default.
